...
{
	AccSavedCaliData.AccXOffset		=0;
    AccSavedCaliData.AccYOffset =0;
    AccSavedCaliData.AccZOffset =0;
  ...
  for (i = 0; i < 300; i++)
  {
    ...
    AccSavedCaliData.AccXOffset		+= mpu_buf[0] << 8 | mpu_buf[1];
    AccSavedCaliData.AccYOffset += mpu_buf[2] << 8 | mpu_buf[3];
    AccSavedCaliData.AccZOffset += mpu_buf[4] << 8 | mpu_buf[5];

    GyroSavedCaliData.GyroXOffset += mpu_buf[8] << 8 | mpu_buf[9];
    GyroSavedCaliData.GyroZOffset += mpu_buf[10] << 8 | mpu_buf[11];
    GyroSavedCaliData.GyroZOffset += mpu_buf[12] << 8 | mpu_buf[13];

    delay_ms(5);
  }
  AccSavedCaliData.AccXOffset /= 300;
  AccSavedCaliData.AccYOffset /= 300;
  AccSavedCaliData.AccZOffset /= 300;
  GyroSavedCaliData.GyroXOffset /= 300;
  GyroSavedCaliData.GyroYOffset /= 300;
  GyroSavedCaliData.GyroZOffset /= 300;
}
